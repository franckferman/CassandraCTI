...
| [`category-digests`](category-digests/) | **Top-N digests per category in separate channels**: 6h news, daily ransomware, daily+weekly CVE. | Discord ×3 | `DISCORD_WEBHOOK_NEWS`, `…_RANSOMWARE`, `…_CVE` (+ Ollama/LLM key) |
